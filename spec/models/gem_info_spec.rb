...
RSpec.describe GemInfo, type: :model do
  ...
  context 'updates all gem version if' do
    subject(:gem_info) { create :gem_info }

    before do
      create :gem_version, gem_info: gem_info, version: '1.2.3'
      create :gem_version, gem_info: gem_info, version: '1.2.4'
      create :gem_version, gem_info: gem_info, version: '1.2.4.beta1'
      create :gem_version, gem_info: gem_info, version: '2.0.0.beta1'

      expect(gem_info.gem_versions.map {|v| [v.version, v.send(:outdated)] }).to eq [
        ['1.2.3', true],
        ['1.2.4', false],
        ['1.2.4.beta1', true],
        ['2.0.0.beta1', false],
    ...
    it 'a newer version gets added' do
      create :gem_version, gem_info: gem_info, version: '2.0.0'
      ...
      expect(gem_info.newest_gem_version.version).to eq '2.0.0'
    end

    it 'an older version gets added' do
      create :gem_version, gem_info: gem_info, version: '1.2.1'
      ...
      expect(gem_info.newest_gem_version.version).to eq '1.2.4'
    end

    it 'a prerelease version gets added' do
      create :gem_version, gem_info: gem_info, version: '3.0.0.alpha'
    ...
    it 'the newest version gets destroyed' do
      gem_info.gem_versions.where(version: '1.2.4').first!.destroy
      ...
      expect(gem_info.newest_gem_version.version).to eq '1.2.3'
    end

    it 'an older version gets destroyed' do
      gem_info.gem_versions.where(version: '1.2.3').first!.destroy
    ...
    it 'a current prerelease version gets destroyed' do
      gem_info.gem_versions.where(version: '2.0.0.beta1').first!.destroy
    ...
    it 'an outdated prerelease version gets destroyed' do
      gem_info.gem_versions.where(version: '1.2.4.beta1').first!.destroy
